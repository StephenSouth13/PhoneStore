    ...
    <footer class="modern-footer">
        <div class="footer-content">
            <div class="footer-left">
                <a href="index.html" class="footer-logo">Smart Phone Store</a>
                <span class="footer-divider">|</span>
                <span>All rights reserved © 2025</span>
            </div>
            <div class="footer-right">
                Designed by 
                <a href="https://www.facebook.com/vietnamstudentmarathon" target="_blank" style="color:#00bfff; font-weight:bold; text-decoration:none;">
                    VietNamStudent Marathon
                </a>
            </div>
        </div>
    </footer>
